...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function createListHtml(allMyWonders) {
    return Object.values(allMyWonders)
      .map(key => {
        return `
        <li class="list_item">
  ...
  const btnMarkup = createListHtml(sevenWonders);
  ...
  function changeContentByID(allMyWonders) {
    ...
    list.addEventListener('click', buttonEvent.bind(sevenWonders));
  }
  ...
  function buttonEvent(e) {
    ...
    let keysNames = Object.values(this);
